...
import { getDataUriFromFileUri } from "./getDataUriFromFileUri.js";
import { useLocalUri } from "./useLocalUri.js";
...
export const useFileUri = (
  [remoteMeta, setRemoteMeta]: UseFile2,
  axios = useAxios(),
): [
  ...
  const [localUri, setLocalUri] =
    useLocalUri(remoteMeta ? remoteMeta.id : undefined) ?? [];
